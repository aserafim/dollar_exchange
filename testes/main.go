...
func main3() {
	// os.Remove("../db/sqlite-database.db") // I delete the file to avoid duplicated records.
	...
	sqliteDatabase, _ := sql.Open("sqlite3", "../db/./sqlite-database.db") // Open the created SQLite File
